...
void initializeDefaultScene(out STriangle triangles[13], out SSphere spheres[2])
{
    ...
    ///Test triangle
    //triangles[12].v1 = vec3(5.0, -5.0, 0.0);
    //triangles[12].v2 = vec3(0.5, -5.0, 0.0);
    //triangles[12].v3 = vec3(0.5, -2.0, 0.0);
    ...
    spheres[1].Center = vec3(-1.5, -1.5, -2.0);
    spheres[1].Radius = 1.8;
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[10])
{
    ...
    // Right wall material (red)
    materials[2].Color = vec3(0.7, 0.2, 0.2);
